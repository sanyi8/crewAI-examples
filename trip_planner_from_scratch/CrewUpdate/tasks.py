...
class AINewsletterTasks():
    def fetch_news_task(self, agent):
        return Task(
            ...
            expected_output="""A listo of top AI news stories titles, URLs, and a brief summary for each story from the past 24 hours.
            Example Output:
            [
    ...
    def analyze_news_task(self, agent, context):
        return Task(
            description='Analyze each news story and ensure there are at least 5 well-formated articles'
            agent=agent,
            async_execution=True,
            context=context,
            expected_output="""A markdown-formatted analysis for each news story, including a rundown, detailed bullet points and a "Why it matters" section. There should be at least 5 articles, each following the proper format.
            Example Output:
            ...
            **Why it matters:** While AI-related ads have been rampant over the last year, its Super Bowl presence was a significant one.
